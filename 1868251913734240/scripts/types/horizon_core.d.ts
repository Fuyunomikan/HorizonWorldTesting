...
export declare class World {
     ...
     *
     * In horizon, every world comes with a team management logic.
     * Players, at any moment during their session, can join, leave or change teams at will.
     * But a player can only be in one team of a given team group.
     *
     * Team groups are ways to separate teams in different sets.
     * This allows the creation of multiple gameplay bubbles with their own teams in one single world.
     */
    team: ITeam;
}
/**
